...
{ include("strategies/coalition/coalition.asl", coalition) }

+!add_initiator
<- 	
//	actions.storeStatistics(endRound,teste1,teste2);
//	actions.storeStatistics(endRound,teste3,teste4,teste5);
...
//	!action::recharge_is_new_skip;
	...
	if ( Me == vehicle1 ) {
		...
		?default::numberOfShops(NShops);
		?default::numberOfWorkshops(NWorkshops);
		?default::numberOfStorages(NStorages);
